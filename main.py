    ...
    if spa_hotel.availability():
        ...
        if credit_card.validate("12/26", "JOHN SMITH", "123"):
            ...
            if credit_card.authenticate(given_pass="mypass"):
                ...
                reservation_ticket = ReservationTicket(customer_name, spa_hotel)
                print(reservation_ticket.generate())
                spa_aws = input("Do you want to book a SPA package? : ")
                spa = SpaHotel(spa_hotel)
                if spa_aws.lower() == "yes":
                    spa_ticket = SpaTicket(customer_name, spa_hotel)
        ...
        msg = f'The Hotel "{spa_hotel.name}" in "{spa_hotel.city}" is NOT Free'
        print(msg)
else:
